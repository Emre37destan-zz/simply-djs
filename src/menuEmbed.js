...
try {
  if(options.slash === true){
    ...
    let type = Number(typ)
    if (type > 2) throw new Error('2den fazla Tip yoktur. TİP 1: GEÇİCİ MSG GÖNDER | TİP 2: MSGYİ DÜZENLE');
    ...
    let slct = new MessageSelectMenu()
      .setMaxValues(1)
      .setCustomId('help')
      .setPlaceholder(options.placeHolder || 'Açılır Sayfalar')
      .addOptions([
        menuOptions
      ])
  ...
  console.log(`Hata oluştu. | menüSayfalar | Hata: ${err}`)
}
